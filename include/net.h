...
static __always_inline_u struct eth_device *eth_get_dev(void)
{
	return eth_current;
}
...
/* Set active state */
static __always_inline_u int eth_init_state_only(void)
{
...
/* Set passive state */
static __always_inline_u void eth_halt_state_only(void)
{
...
static __always_inline_u int eth_is_on_demand_init(void)
{
#ifdef CONFIG_NETCONSOLE
